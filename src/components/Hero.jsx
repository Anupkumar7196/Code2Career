  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from purple-800 to bg-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        ...
        <p className='mb-8 max-w-xl mx-auto text-sm fon-light px-5'>Your Next Big Career Move Starts Right Here - Explore the Best Job Opportunities and Take the First Step Toward Your Future!</p>
        <div className='flex items-center justify-between bg-white rounded text-gray-600 mx-w-xl pl-4 mx-4
         sm:mx-auto'>
